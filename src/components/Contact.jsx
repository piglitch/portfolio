...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    emailjs.send('service_cws1d5b', 'template_x0nxt2r', 
    {
      from_name: form.name,
      to_name: 'Avi',
      from_email: form.email,
      to_email: 'avibanerjee2000@gmail.com',
    ...
    .then(() => {
      setLoading(false);
      alert('Thank you. I will get back to you as soon as possible. Stay awesome🤙!');
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea 
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Got something to say? Shoot!"
              className='bg-tertiary py-4 px-6 
              placeholder:text-secondary
              text-white rounded-lg outlined-none
              border-none font-medium'
